...
<div class="div-3" style="margin: 25px 60px 60px;background-color: white">
	...
	<div class="input-group" style="float: left">  
       <input id="searchByName" type="text" class="form-control"placeholder="搜索" style="width: 180px;margin-left: 20px;"/>
           <button class="btn-info" id="search" onclick="search()"><span class="glyphicon glyphicon-search"></span></button>
	</div>
...
<!-- 						<tr class="success"> -->
<!-- 							<td>姓  名</td> -->
<!-- 							<td><input id="name" value="${account.name }" style="width:350px;height: 40px;position: relative;font-size: 14px;" ></td> -->
<!-- 						</tr> -->
<!-- 						<tr class="warning"> -->
<!-- 							<td>年  龄</td> -->
...
<script>
	...
	function update() {
		...
		$.post("<%=basePath%>account/searchAccountById",{
			'id':id
			})
		$('#myModal').modal('show');
    }
	...
	function search() {
		...
		$.post("<%=basePath%>account/searchByName",{
			'name':name
			})
    };
